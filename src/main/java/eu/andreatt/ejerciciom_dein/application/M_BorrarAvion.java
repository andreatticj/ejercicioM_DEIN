...
/**
 * La clase M_BorrarAvion representa una ventana para borrar un avión
 * de la aplicación. Hereda de la clase Stage de JavaFX.
 */
public class M_BorrarAvion extends Stage {

    /**
     * Constructor de la clase M_BorrarAvion.
